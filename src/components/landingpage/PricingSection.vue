<template>
  <section id="pricing" class="pb-8">
          ...
          <v-card style="width: 100%">
            ...
            <v-row class="text-center">
              <v-col class="col-12 col-sm-6 col-md-4">
                ...
                <v-divider class="mx-4" v-if="!this.$vuetify.breakpoint.mdAndUp"></v-divider>
              </v-col>
              <v-col class="col-12 col-sm-6 col-md-4">
                <div class="flex-center">
                  <v-card-text>
    ...
    <div class="svg-border-rounded text-light">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" preserveAspectRatio="none" fill="currentColor">
        <path
...
export default {
  ...
  computed: {
    size() {
      const size = { sm: "large", md: "large", xl: "x-large" }[
